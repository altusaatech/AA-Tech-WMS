...
export const BOM_COLUMNS: SalesColDef[] = [
  ...
  { key: "bomStatus", label: "BOM Status", type: "text", width: 130 },
  { key: "reasonsForDelay", label: "Reasons for Delay", type: "text", width: 200 },
  { key: "bomRelatedNotes", label: "BOM Related Notes", type: "text", width: 220 },
  { key: "bomAmendmentNeeded", label: "BOM Amendment Needed", type: "bool", width: 110 },
  { key: "bomAmendmentReasons", label: "BOM Amendment Reasons", type: "text", width: 220 },
  { key: "bomAmendmentDate", label: "BOM Amendment Date", type: "date", width: 150 },
  ...
  { key: "bomTargetDate", label: "BOM Target Date", type: "date", width: 150 },
  { key: "bomActualDate", label: "BOM Actual Date", type: "date", width: 150 },
  { key: "bomNo", label: "BOM No", type: "text", width: 140 },
];
