...
import { ArrowLeft, Save, Printer, Plus, Trash2, Loader2, DoorOpen } from "lucide-react";
...
export function QuotationBuilder({
  ...
  async function save() {
    setSaving(true);
    try {
      await saveQuotation(id, { offerNo, quoteDate, project, customer, subject }, lines, notes);
